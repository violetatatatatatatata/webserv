...
HttpHandler::HttpHandler(const Request& request, const LocationParser* location, const ServerParser& server) : _request(request), _location(location), _server(server)
{
}
